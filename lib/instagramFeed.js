/**
 * Shared Instagram feed fetch for Vite (dev) and Vercel (production).
 *
 * Supports:
...
export async function getInstagramFeedResponse() {
  ...
  if (!token) {
    return {
      ...
      body: {
        error: 'missing_token',
        message:
          'Falta INSTAGRAM_ACCESS_TOKEN (cuenta Instagram Business/Creator).',
      },
    }
  }
